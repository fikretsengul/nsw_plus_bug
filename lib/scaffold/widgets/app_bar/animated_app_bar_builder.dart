...
class _AnimatedAppBarBuilderState extends State<AnimatedAppBarBuilder> with TickerProviderStateMixin {
  ...
  Color _expandedColor(BuildContext context) => Colors.white;
  Color _collapsedColor(BuildContext context) => Colors.white.withOpacity(widget.appBar.hasBackgroundBlur ? 0.5 : 1);
